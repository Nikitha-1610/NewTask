...
//             <div
//               key={task.taskId}
//               className="p-4 bg-gray-50 border rounded-md relative mb-4"  
//             >
...
const MyTask = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case "Assigned":
        return "bg-gray-400"; // Gray for Assigned
      case "In-Progress":
        return "bg-orange-500"; // Orange for In-Progress
      case "In-Test":
        return "bg-red-500"; // Red for In-Test
      case "Completed":
        return "bg-teal-500"; // Teal for Completed
      default:
