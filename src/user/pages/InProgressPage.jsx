  ...
  return (
    <div className="p-4 min-h-screen flex flex-col items-center">
      ...
      <div className="w-full max-w-xl">
        ...
        <div className="flex items-center justify-between bg-yellow-100 rounded-lg px-4 py-2 shadow">
          <h1 className="text-2xl font-bold text-gray-700">IN PROGRESS TASKS</h1>
