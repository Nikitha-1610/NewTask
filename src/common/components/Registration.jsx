                ...
                <div key={field} className="flex flex-col">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="border border-gray-300 rounded-md px-3 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-teal-500 w-full"
                    />
                    <button
                      type="button"
              ...
              return (
                <div key={field} className="flex flex-col">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`border p-2 rounded-md ${errors.gender ? "border-red-500" : "border-cyan-200"}`}
                  >
