  ...
  return (
    ...
    <div className="flex  min-h-screen">
      ...
      {(!selectedContact || window.innerWidth >= 1024) && (
       <div className="w-full lg:w-1/4 border-r border-gray-300  relative z-20 bg-white scrollbar-hide h-screen sticky top-0 overflow-y-auto">
          {/* Header */}
          <div className="mb-2 sticky top-0 bg-white z-10">
            <div className="flex items-center justify-between mb-2">
              <h3 className="sm:text-2xl text-[28px] font-semibold text-gray-800">Chats</h3>
              <FontAwesomeIcon
          ...
          {/* Recent Contacts */}
          <h3 className="text-black-500 font-semibold mb-1 sm:text-xl text-[22px]">Recent</h3>
          <div className="space-y-1 overflow-y-auto">
