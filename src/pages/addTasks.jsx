...
const AddTasks = () => {
  ...
  return (
    <div className="relative flex flex-col m-0 p-0 w-full min-h-screen overflow-hidden add-tasks-container">

 <div className="left-container flex flex-col gap-4 p-4 sm:w-[340px] md:w-[500px] lg:w-[713px]">
      <TaskForm taskData={taskData} setTaskData={setTaskData} />
    </div>   {/* Left Container */}
    

      {/* Right Container for Buttons */}
      <div className="right-3 absolute flex gap-4">
  <Link
  ...
  <div className="fixed inset-0 flex justify-center items-center bg-gray-100 w-full h-full">
    <div className="relative z-10 flex flex-col items-center gap-4 bg-white shadow-lg p-8 sm:p-6 border border-black rounded-lg max-w-96 sm:max-w-lg font-sans">
      {/* Close Icon */}
      ...
      {/* Submit Button */}
      {!isSubmitted && (
        <div className="right-10 sm:right-5 bottom-0 absolute flex flex-col justify-center sm:mt-0 submit-btn-container">
          <button
