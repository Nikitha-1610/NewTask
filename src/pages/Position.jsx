...
const Position = () => {
    return (
            ...
            <tr key={index}>
              ...
              <td className="p-2 text-left border-b-2 border-gray-400/60">
                <div className="flex items-center">
                  <button className="px-2.5 py-1 bg-[#4D50FD] text-white border-none cursor-pointer rounded-lg">Tag</button>
      ...
      <div className="w-[190px] h-[90px] absolute top-80
      ...
      {/* <div className="flex justify-center gap-5 mb-5 relative -left-[480px]"> */}
        ...
        <button className="w-[80px] h-[25px] relative left-8 top-4 bg-[#01C2B5] text-white border-2 border-white cursor-pointer mx-2.5 rounded-3xl hover:bg-[#0056b3]">Submit</button>
        </div>
        {/* </div> */}
      </>
    );
