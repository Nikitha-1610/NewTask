...
const GroupChat = ({ contact, handleBackToContacts }) => {
  ...
  {/* Green online dot */}
  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none" className="right-0 bottom-0 absolute">
...
<div className="flex flex-col gap-2">
  ...
  <div className="flex flex-col bg-white shadow p-2 rounded-lg w-64">
    <div className="flex justify-between w-full">
      <span className="font-semibold text-base text-black">Revathy</span>
  ...
  <div className="flex flex-col gap-2">
    ...
    <div className="flex flex-col bg-white shadow p-2 rounded-lg w-64">
      <div className="flex justify-between w-full">
        <span className="font-semibold text-base text-black">Santosh</span>
        <span className="text-gray-500 text-sm">10:30 AM</span>
      </div>
      <p className="text-base text-black leading-normal">
        Hi, I am having a doubt on profile Screen.
    ...
    <div className="flex flex-col bg-white shadow p-2 rounded-lg w-64 sm:w-[482px]">
      ...
      <div className="flex items-center gap-1 mb-0">
        <span className="font-semibold text-black text-sm">Santosh</span>
      </div>

      {/* Image Attachment */}
      <div className="flex items-center gap-1">
        <img src="/Images/chat1.jpg" alt="specification" className="p-2 h-28" />
      </div>
  ...
  <div className="flex flex-col gap-2">
    ...
    <div className="flex flex-col bg-white shadow p-2 rounded-lg w-64 sm:w-[30rem]">
      ...
      <div className="flex justify-between gap-1 mb-0">
        <span className="flex font-semibold text-base text-black">Reavathy</span>
        <span className="text-gray-500 text-sm">10:45 AM</span>
      </div>

      {/* Image Attachment */}
      <div className="flex items-center gap-1">
        <img src="/Images/chat2.jpg" alt="specification" className="p-2 h-28" />
      </div>
