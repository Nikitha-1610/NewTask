...
const Chat = () => {
  ...
  <div className="flex items-center gap-2 mb-2 p-2 bg-gray-100 border border-gray-300 rounded-md">
 ...
 <div className="flex items-start gap-3">
  ...
  <div className="flex flex-col p-2 w-[482px] bg-white shadow rounded-lg">
    ...
    <div className="flex items-center">
      <img src="/Images/chat2.jpg" alt="specification" className="h-[136px] p-2" />
    </div>
  ...
  <div className="flex flex-col gap-2">
    ...
    <div className="flex flex-col p-2 w-[410px] min-h-[34px] bg-[#E5FDF7] shadow rounded-lg">
      ...
      <div className="flex justify-between w-full mb-2">
        <span className="text-black font-semibold text-[14px]">You</span>
