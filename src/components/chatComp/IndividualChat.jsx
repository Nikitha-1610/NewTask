    ...
    <div className="flex flex-col min-h-full bg-gray-100">
      ...
      <div className="flex items-center justify-between w-full h-[60px] bg-white shadow-md px-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-black font-semibold  text-[12px] sm:text-[15px]">{contact?.name}</span>
        ...
        <div className="flex flex-col gap-1">
          <div className="p-2 w-auto max-w-md bg-white shadow rounded-lg">
            <div className="flex justify-between mb-1">
              <span className="text-black font-semibold text-[14px]">{contact?.name}</span>
              <span className="text-gray-500 text-[12px]">10:30 AM</span>
            </div>
            <p className="text-black text-[14px]">
              {index === 0
                ? contact.lastMessage // Render the first message from the contact array
