...
const TwoWaveChart = () => {
  return (
    <div className="s:w-full  h-80 max-w-screen-lg mx-auto relative flex flex-col sm:items-center">
      {/* Calendar Icon on the Top Left */}
      <div className="sm:absolute absolute top-0 gap-2 left-0 flex items-center text-gray-400 bg-blue-50 sm:p-1 p-0.5 rounded-md">
