...
const Production = () => {
  ...
  <thead>
    <tr>
      <th className="font-medium text-[#A3AED0] text-[16px] sm:text-[18px] md:text-[22.661px] font-[DM Sans] leading-[18px] sm:leading-[20px] md:leading-[21.705px] tracking-[-0.253px] p-1 sm:p-2 text-left">
        NAME
      </th>
      <th className="font-medium text-[#A3AED0] text-[16px] sm:text-[18px] md:text-[22.661px] font-[DM Sans] leading-[18px] sm:leading-[20px] md:leading-[21.705px] tracking-[-0.253px] p-1 sm:p-2 text-left">
        STATUS
  ...
  <tbody>
    {data.map((row, index) => (
      <tr key={index} className="border-b-0">
        <td className="p-1 sm:p-2 text-[#2B3674] font-[sans-serif] text-[14px] sm:text-[16px] md:text-[16.661px] font-bold leading-[18px] sm:leading-[21px] tracking-[-0.253px]">
          {row.name}
        </td>
        <td className="p-1 sm:p-2 text-[#2B3674] font-[sans-serif] text-[14px] sm:text-[16px] md:text-[16.661px] font-bold leading-[18px] sm:leading-[21px] tracking-[-0.253px] flex items-center">
          {row.status === 'Assigned' ? (
            <FaCheckCircle className="text-[#05CD99] mr-1 sm:mr-2" size={14} sm:size={16} md:size={18} />
          ) : (
            <FaExclamationCircle className="text-[#FFCE20] mr-1 sm:mr-2" size={14} sm:size={16} md:size={18} />
          )}
          {row.status}
        </td>
        <td className="p-1 sm:p-2 text-[#2B3674] font-[sans-serif] text-[14px] sm:text-[16px] md:text-[16.661px] font-bold leading-[18px] sm:leading-[21px] tracking-[-0.253px]">
        ...
        <td className="p-1 sm:p-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="90" sm:width="70" md:width="80" height="10" sm:height="10" md:height="10" viewBox="0 0 99 9" fill="none">
...
const data = [
  ...
  { name: 'Deployment', status: 'Assigned', date: '30-May-21', progress: 80 },
